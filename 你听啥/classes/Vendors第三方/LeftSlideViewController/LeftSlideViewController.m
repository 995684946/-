...
//        [self.leftVC.view addSubview:view];
        ...
        self.leftTableview.frame = CGRectMake(0, 0, kScreenWidth - kMainPageDistance +100, kScreenHeight);
...
-(void)handeTap:(UITapGestureRecognizer *)tap{
    ...
    if ((!self.closed) && (tap.state == UIGestureRecognizerStateEnded))
    {
        ...
        tap.view.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2,[UIScreen mainScreen].bounds.size.height/2 - 25);
        self.closed = YES;
        
        self.leftTableview.center = CGPointMake(kLeftCenterX, kScreenHeight * .5);
...
- (void)closeLeftView
{
    ...
    self.mainVC.view.center = CGPointMake(kScreenWidth / 2, kScreenHeight / 2 - 25);
    self.closed = YES;
...
- (void)openLeftView;
{
    ...
    self.leftTableview.center = CGPointMake((kScreenWidth - kMainPageDistance - 100) * 0.5, kScreenHeight * 0.5);
